...
This repository currently contains the workflow for harmonization of Medicare data for 1999 - 2018 (Medicaid is WIP)
...
1. Master beneficiary summary part d (mbsf_d)
...
## Repository Contents 
- src/harmonize.py -> Builds and executes Duckdb queries based on specifications from medicare.yml
